...
const stage = new Stage(daily, tomorrow, weekly, monthly, characteristic, otherHoroscope);
...
bot.command('начать', ctx => {
    ctx.reply('Привет! Я - ГороБот, могу рассказать тебе гороскоп и характеристику твоего знака зодиака.🔮\nЧтобы начать работу со мной отправь мне "Гороскоп" или "Характеристика". Если думаешь, что буквы платные, можешь нажать на кнопку ниже😆\n\nПовторюсь. В дальнейшем, если собираешься использовать меня просто пиши мне "Гороскоп" или "Характеристика" или отправь любой символ и тогда я пришлю тебе клавиатуру😉', null, Markup.keyboard([
