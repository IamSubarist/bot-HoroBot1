...
// const monthly = new Scene('monthly',
//   (ctx) => {
//     ctx.scene.next();
...
//             axios.get('https://www.elle.ru/astro/aries/month').then(html => {
...
//             axios.get('https://www.elle.ru/astro/taurus/month').then(html => {
//                 const $ = cheerio.load(html.data)
//                 var text = ''
//                 $('body > div.container.container3 > div:nth-child(4) > div.c2.ntm.nbm.rm > div:nth-child(1) > div > div:nth-child(2) > div > p:nth-child(2)').each((i, elem) => {
//                     text += `${$(elem).text()}\n`
...
//             axios.get('https://www.elle.ru/astro/gemini/month').then(html => {
//                 const $ = cheerio.load(html.data)
//                 var text = ''
//                 $('body > div.container.container3 > div:nth-child(4) > div.c2.ntm.nbm.rm > div:nth-child(1) > div > div:nth-child(2) > div > p:nth-child(2)').each((i, elem) => {
//                     text += `${$(elem).text()}\n`
...
//             axios.get('https://www.elle.ru/astro/cancer/month').then(html => {
//                 const $ = cheerio.load(html.data)
//                 var text = ''
//                 $('body > div.container.container3 > div:nth-child(4) > div.c2.ntm.nbm.rm > div:nth-child(1) > div > div:nth-child(2) > div > p:nth-child(2)').each((i, elem) => {
//                     text += `${$(elem).text()}\n`
...
//             axios.get('https://www.elle.ru/astro/leo/month').then(html => {
//                 const $ = cheerio.load(html.data)
//                 var text = ''
//                 $('body > div.container.container3 > div:nth-child(4) > div.c2.ntm.nbm.rm > div:nth-child(1) > div > div:nth-child(2) > div > p:nth-child(2)').each((i, elem) => {
//                     text += `${$(elem).text()}\n`
...
//             axios.get('https://www.elle.ru/astro/virgo/month').then(html => {
//                 const $ = cheerio.load(html.data)
//                 var text = ''
//                 $('body > div.container.container3 > div:nth-child(4) > div.c2.ntm.nbm.rm > div:nth-child(1) > div > div:nth-child(2) > div > p:nth-child(2)').each((i, elem) => {
//                     text += `${$(elem).text()}\n`
...
//             axios.get('https://www.elle.ru/astro/libra/month').then(html => {
//                 const $ = cheerio.load(html.data)
//                 var text = ''
//                 $('body > div.container.container3 > div:nth-child(4) > div.c2.ntm.nbm.rm > div:nth-child(1) > div > div:nth-child(2) > div > p:nth-child(2)').each((i, elem) => {
//                     text += `${$(elem).text()}\n`
...
//             axios.get('https://www.elle.ru/astro/scorpio/month').then(html => {
//                 const $ = cheerio.load(html.data)
//                 var text = ''
//                 $('body > div.container.container3 > div:nth-child(4) > div.c2.ntm.nbm.rm > div:nth-child(1) > div > div:nth-child(2) > div > p:nth-child(2)').each((i, elem) => {
//                     text += `${$(elem).text()}\n`
...
//             axios.get('https://www.elle.ru/astro/sagittarius/month').then(html => {
//                 const $ = cheerio.load(html.data)
//                 var text = ''
//                 $('body > div.container.container3 > div:nth-child(4) > div.c2.ntm.nbm.rm > div:nth-child(1) > div > div:nth-child(2) > div > p:nth-child(2)').each((i, elem) => {
//                     text += `${$(elem).text()}\n`
...
//             axios.get('https://www.elle.ru/astro/capricorn/month').then(html => {
//                 const $ = cheerio.load(html.data)
//                 var text = ''
//                 $('body > div.container.container3 > div:nth-child(4) > div.c2.ntm.nbm.rm > div:nth-child(1) > div > div:nth-child(2) > div > p:nth-child(2)').each((i, elem) => {
//                     text += `${$(elem).text()}\n`
...
//             axios.get('https://www.elle.ru/astro/aquarius/month').then(html => {
//                 const $ = cheerio.load(html.data)
//                 var text = ''
//                 $('body > div.container.container3 > div:nth-child(4) > div.c2.ntm.nbm.rm > div:nth-child(1) > div > div:nth-child(2) > div > p:nth-child(2)').each((i, elem) => {
//                     text += `${$(elem).text()}\n`
...
//             axios.get('https://www.elle.ru/astro/pisces/month').then(html => {
//                 const $ = cheerio.load(html.data)
//                 var text = ''
//                 $('body > div.container.container3 > div:nth-child(4) > div.c2.ntm.nbm.rm > div:nth-child(1) > div > div:nth-child(2) > div > p:nth-child(2)').each((i, elem) => {
//                     text += `${$(elem).text()}\n`
